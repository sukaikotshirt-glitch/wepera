const Logic_MT = {
    ...
    // ✅ MT Password for validation
    MT_PASSWORD: "4142434445464748",  // "ABCDEFGH" in hex
    
    // ✅ Session authentication flag
    isAuthenticated: false,

    init: function() {
        this.currentMeter = MT_PROFILE; 
    ...
    validateAARQ: function(hexStr) {
        // Check if MT password exists in AARQ
        // MT Password: "ABCDEFGH" = 4142434445464748
        if (hexStr.toUpperCase().includes(this.MT_PASSWORD.toUpperCase())) {
            return true;
        }
        return false;
    },
    ...
    processPacket: function(hexStr) {
        ...
        // MT SPECIFIC: Check for NEXT FRAME request first
